...
import ResultValue.ReceiveTimeout
import org.arw357.pekko.testkit.specs2.api.UntypedFullReceiveMatcher
import org.arw357.pekko.testkit.specs2.impl.Matchers._
...
trait PekkoMatchers {
  ...
  private[this] def pekkoClassicReceiveMatcher(
